  ...
  static Route<dynamic> generateRoute(RouteSettings setting) {
    switch (setting.name) {
      ...
      case RoutesName.onboardscreen1:
        return MaterialPageRoute(builder: ((context) => const onboardscreen1()));
      case RoutesName.onboardscreen2:
        return MaterialPageRoute(builder: ((context) => const onboardscreen2()));
      case RoutesName.onboardscreen3:
        return MaterialPageRoute(builder: ((context) => const onboardscreen3()));
      case RoutesName.onboardscreen4:
        return MaterialPageRoute(builder: ((context) => const onboardscreen4()));
      case RoutesName.onboardscreen5:
        return MaterialPageRoute(builder: ((context) => const onboardscreen5()));
